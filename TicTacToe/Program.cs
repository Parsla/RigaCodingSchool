...
namespace TicTacToe
{
    class Program
    {
        ...
        {
            // 1. Pārbaudām, vai nav kāda rinda, kurā visas vērtības FieldEnum.X vai FieldEnum.O
            ...
            // 2. Pārbaudām, vai nav kāda kolonna, kurā visas vērtības FieldEnum.X Vai FieldEnum.O
            ...
            // 3. Pārbaudām, vai nav diag., kurā visas vērtības FieldEnum.X vai FieldEnum.O
            ...
            if (board[0, 2] != FieldEnum.Empty && board[0, 2] == board[1, 1]
                && board[1, 1] == board[2, 0])
            {
                Console.WriteLine($"Uzvarētājs: {board[0, 0]}");
                return true;
            }
            // 4. Pārbaudām, vai visi lauki aizpildīti (neviens nav FieldEnum.Empty)
            for (int i = 0; i < board.GetLength(0); i++)
            {
